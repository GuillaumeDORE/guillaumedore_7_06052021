...
router.put('/:comment_id',auth ,/*  createAccountLimiter ,*/ commentCtrl.update_comment);
router.delete('/:comment_id',auth ,/*  createAccountLimiter ,*/ commentCtrl.delete_comment);
